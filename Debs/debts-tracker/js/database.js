window.DB = {
  currentUser: localStorage.getItem("current_session_user") || "demo_user",
  get KEY() {
  ...
  add(name, amount, category, phone = "", comment = "", date = "") {
